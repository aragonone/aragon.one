      ...
      <JobOpening
        ...
        description={
          <span>
            ...
            <br /> <br />
            Our CEO is highly energetic, creative, and motivated and transmits that
            to others around him. His day to day consists of balancing the urgent with
            the important, mixing trips, calls, and focus work. As the CEO of a fast-growing 
            company in an emerging ecosystem, his agenda is very dynamic, involving different 
            stakeholders. Learn more about him through this
            <a href="https://blog.aragon.one/team-interviews-jorge-aragons-tech-lead-dae54d7eacac/" target="_blank">
              Team Interview
            </a>
            .
            <br /> <br />
            You’re someone energetic who thrives in dynamic environments, and you’re
            not put off by uncertainty. You can efficiently research and compare options 
            to facilitate decision-making, you can take unclear tasks, figure out boundaries, 
            and get them done, and you work well time and resource-constrained.
            <br /> <br />
            Given our sector, it’s important to be open-minded, a fast learner, and being 
            comfortable with technology and tech-related concepts. This is a remote position 
            but you must be willing to travel if necessary.
          </span>
        }>
        <h5>Responsibilities</h5>
        <ul>
          <li>
            Managing his agenda, prioritizing, scheduling, and rescheduling business 
            and personal appointment across timezones.
          </li>
          <li>
            Managing business and personal travel logistics, from the accommodation, 
            flights, transfers, and rental-car bookings to itinerary definition.
          <li>
            Handle personal admin tasks: insurance, managing household maintenance, 
            making appointments, reviewing correspondence, and other related tasks.
          </li>
        <h5>Nice to have</h5>
        <ul>
        ...
        <ul>
          <li>
            ...
            with your Linkedin and/or CV, and any information you
            consider important.
          </li>
        </ul>
      </JobOpening>
